...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>ETo-Let ||Contact Us</title>
</head>
...
?>
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="contact-panel">
                            ...
                            <p>+880<?php  echo $row['MobileNumber'];?></p>
                        </div>
                        <!-- .contact-panel -->
                        <div class="contact-panel">
                            <h3>Email:</h3>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-1 bg-white p-30 bg-white">
                        ...
                        <div class="about--img"><img class="img-responsive" src="assets/images/about/tolet_v1.jpg" width="2000" height="2000" alt="about img"></div>
                    </div>
                    <!-- .col-md-8 end -->
                </div>
               <?php } ?>
