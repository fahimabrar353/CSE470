...
<head>
    ...
    <title>ETo-Let || Manage Property</title>
    <script>
...
?>           <div class="form-box">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="propertydescription" id="propertydescription" rows="2" value="<?php  echo $row['PropertDescription'];?>">
              ...
              ?>      
                  ...
                  <?php } ?>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="select-status">Price range</label>
                                            <div class="select--box">
                                                <i class="fa fa-angle-down"></i>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="Area">Area (Apartment)</label>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="Size">Size (Office / Bachelor rooms)</label>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="Sale-Rent-Price">Rent Price* <strong style="color: red;">[2% charge has been added automatically]</strong></label>
                                            <input type="text" class="form-control" name="salerentprice" id="salerentprice" required="true" value="<?php  echo $row['RentorsalePrice'];?>" readonly>
                                        </div>
                                    </div>
                                    <!-- 
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                            ...
                            <div class="form-box">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        <div class="input-checkbox">
                                            <label class="label-checkbox">
                                        <span>Transportation Nearby</span>
