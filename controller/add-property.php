...
$area=$_POST['area'];
$size=$_POST['size'];
$firstPrice=$_POST['salerentprice'];
...
<head>
    ...
    <title>ETo-Let || Add Property</title>
</head>
<script>
    ...
    echo $msg;
              ...
              ?>      
                  ...
                  <?php } ?>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="Sale-Rent-Price">Rent Price <strong style="color: red;">[2% charge will be added automatically]</strong></label>
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4">
                                      ...
                                      <div class="col-xs-4 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="galleryimage3">
                                        </div>
                                    </div>
                                      <div class="col-xs-4 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="address">Gallery Image4</label>
                                            <input type="file" class="form-control" name="galleryimage4" >
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="address">Gallery Image5</label>
                                            <input type="file" class="form-control" name="galleryimage5" >
                                        </div>
                                    </div>
                                    <!-- .col-md-12 end -->
