...
if(isset($_POST['submit']))
  {
    ...
    $proid=$_GET['proid'];
    $ret11=mysqli_query($con,"select * from tbluser join tblproperty on tblproperty.UserID=tbluser.ID where tblproperty.ID=$proid");
    $row11=mysqli_fetch_array($ret11);
    $ownerNumber=$row11['MobileNumber'];
    $etoletNumber='01777617054';
    ...
    $ownerMessage="Welcome from ETo-Let. Dear Manager you have a request from, Name: $fullname, MobileNumber: $mobilenumber and Message: ( $message ). Please process this ETo-Let request soon. Enquery Number: $enquirynumber" ;
...
<head>
    ...
    <link href="assets/css/style.css?tolet=v41" rel="stylesheet">
    ...
    <!-- Document Title
    ============================================= -->
    <title>ETo-Let || Single Property Detail</title>
</head>
                        ...
                        <div class="property-single-gallery-info">
                            <div class="property--info clearfix">
                                <div class="pull-left">
                                    ...
                                    <p class="property--location"><?php echo $row['Address'];?>, <?php echo $row['City'];?>, <?php echo $row['StateName'];?>-<?php echo $row['ZipCode'];?>,<?php echo $row['CountryName'];?></p>
                                </div>
                                <div class="pull-right">
                                    <span class="property--status">Range: <?php echo $row['Status'];?></span>
                                    <p class="property--price">BDT <?php echo $row['RentorsalePrice'];?></p>
                                </div>
                            </div>
                            <!-- .property-info end -->
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8">
                        <div class="property-single-carousel inner-box">
                            <div class="row">
								...
								<img src="propertyimages/<?php echo $row['FeaturedImage'];?>" alt="ETo-Let" width="100" height='100'>
							</button>
                                            <button class="owl-thumb-item">
						   		<img src="propertyimages/<?php echo $row['GalleryImage1'];?>" alt="ETo-Let" width="100" height='100'>
						   </button>
                                            <button class="owl-thumb-item">
								<img src="propertyimages/<?php echo $row['GalleryImage2'];?>" alt="ETo-Let" width="100" height='100'>
							</button>
                                            <button class="owl-thumb-item">
								<img src="propertyimages/<?php echo $row['GalleryImage3'];?>" alt="ETo-Let" width="100" height='100'>
							</button>
                                            <button class="owl-thumb-item">
								<img src="propertyimages/<?php echo $row['GalleryImage4'];?>" alt="ETo-Let" width="100" height='100'>
							</button>
                            <button class="owl-thumb-item">
                                <img src="propertyimages/<?php echo $row['GalleryImage5'];?>" alt="ETo-Let" width="100" height='100'>
                            </button>
                                        </div>
                                    </div>
                                    <!-- .col-md-12 end -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <ul class="list-unstyled mb-20">
                                        ...
                                        <li><span>Division:</span><?php echo $row['StateName'];?></li>
                         ...
                         <?php } ?>
                            ...
                            <div class="widget--content">
                                ...
                                <div class="agent--contact">
                                    ...
                                    <a class="btn btn--primary btn--block" href="tel:01777617054">Call For visit</a>
...
{ ?>
                        <div class="widget widget-request">
                            <div class="widget--title">
                                <h5>If you want to contact the owner fillup the form below </h5>
                            </div>
                            <div class="widget--content">
                                <form class="mb-0" method="post">
                                    <div class="form-group">
                                        <label for="contact-name">Your Name*</label>
                                        <input type="text" class="form-control" name="fullname" id="fullname" required="true" placeholder="Your Name">
                                    </div>
                                    <!-- .form-group end -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="mobnum" id="mobnum" required="true" maxlength="11">
                                    </div>
                                    <!-- .form-group end -->
                                    <div class="form-group">
                                        <label for="message">Short Message*</label>
                                        <textarea class="form-control" name="message" id="message" maxlength = "60" rows="2" required="true"></textarea>
                                    </div>
                                    <!-- .form-group end -->
...
?>
     ...
     <div class="widget widget-request">
                            <div class="widget--title">
                                <h5>To meet the owner/ visit the Tolet, fill the form below</h5>
                            </div>
                            <div class="widget--content">
                                <form class="mb-0" method="post">
                                    <div class="form-group">
...
<input type="text" class="form-control" value="<?php echo $fname;?>" name="fullname" id="fullname" required="true" readonly="true" >
                                    ...
                                    <div class="form-group">
                                        <label for="contact-email">Email Address(Optional)</label>
<input type="email" class="form-control" value="<?php echo $uemail;?>"  name="email" id="email"  readonly="true">
                                    </div>
                                    <!-- .form-group end -->
                                    <div class="form-group">
                                        <label for="contact-phone">Phone Number*</label>
...
<!-- widget mortgage calculator=============================-->
                        ...
                        <div class="widget widget-mortgage-calculator">
                            <div class="widget--title">
                                <h5>ETo-Let Fee calculator</h5>
                            </div>
                            <div class="widget--content">
     <form class="mb-0" method="post" action="calculator.php">
                                    <div class="form-group">
                                        <label for="sale-price">Sale Price</label>
                                        <input type="text" class="form-control" name="saleprice" id="saleprice" placeholder="BDT" required="true">
                                    </div>
                                    <!-- .form-group end -->
                                    <!--
                                    <div class="form-group">
